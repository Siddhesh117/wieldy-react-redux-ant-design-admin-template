      ...
      <Row>
        ...
        <Col xl={8} lg={10} md={12} sm={12} xs={12} className="gx-text-right">
          <div className="gx-flex-column gx-justify-content-center gx-h-100">
            <span className="gx-mb-2 gx-app-thumb"><img src={"https://via.placeholder.com/97X32"} alt="..."/>
            </span>
            <span className="gx-app-thumb"><img src={"https://via.placeholder.com/97X32"} alt="..."/></span>
          </div>
        </Col>
      </Row>
    </Widget>
